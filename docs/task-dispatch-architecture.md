...
观测层：React 看板 + 实时API (Dashboard + Real-time Analytics)
  ├─ 任务看板：12个功能面板（旨意看板 / 待批专面板 / 朝堂议政 / 省部调度 / 急递铺·国史馆 / 官员总览 / 模型配置 / 技能配置 / 小任务 / 奏折阁 / 旨库 / 天下要闻）
...
| **完全可观测** | 12 个功能面板 + 59条活动/任务 | 实时看到任务卡在哪、谁在工作、工作状态如何 |
...
2. 待批专面板
   ├─ 集中查看 PendingConfirm 待批事项
   ├─ 一键准奏 / 封驳
   └─ 展示最近 gate_checks 审批历史
